...
export default function Auth({ onAuth }) {
  ...
  return (
    <div style={styles.shell} className="auth-shell">
      ...
      {/* LEFT PANEL */}
      <div style={styles.left} className="auth-left-panel">
        <div style={styles.leftGlow}/>
        <div style={styles.logo} onClick={()=>navigate('/')} style={{...styles.logo,cursor:'pointer'}}>Organized<span style={{color:'#b5893a'}}>.</span></div>
...
const mobileCSS = `
  @media (max-width: 768px) {
    ...
    .auth-right-panel { padding: 2.5rem 1.5rem !important; }
  }
`
