...
export default function PublicBookingPage() {
  ...
  if (notFound) return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'#f7f5f0',gap:'1rem'}}>
      <div style={{fontFamily:"'Playfair Display',serif",fontSize:'1.5rem',color:'#b5893a'}}>Organized.</div>
      <div style={{fontSize:'.9rem',color:'#7a7774'}}>This studio page could not be found.</div>
      <button onClick={()=>navigate('/')} style={{marginTop:'.5rem',padding:'.5rem 1.25rem',border:'1px solid #e4e2dc',borderRadius:8,background:'#fff',cursor:'pointer',fontFamily:'inherit',fontSize:'.85rem'}}>Go home</button>
    </div>
  )

  return <ClientPage workspace={workspace} />
}
